...
client.on('messageCreate', async (message) => {
    ...
    if (message.content.startsWith('!ask ')) {
        ...
        try {
            ...
            const systemPrompt = "You are a Discord bot with internet access. You can search the web and access current information. When users ask about your capabilities, tell them you have internet access and can search for current information using web search.";
